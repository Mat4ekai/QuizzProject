...
/*
    ...
    Compiled: 21.11.2022 13:48:09
    TPL file: /registration.tpl
*/
function tpl_aeef96d741744727422490f355fa7ec3(Template $__tpl, &$__tpl_data){
?>
...
<section id="regsec" class="mt-3 rounded shadow p-3 mb-5 bg-body rounded">
    <div id="regrow">
        ...
        <form method="POST" action="" value="SendForm">
            ...
            <div class="row mb-4">
                <button type="button" class="btn btn-primary btn-block float-end"><a class="text-light" href="index">Зарегистрироваться</a></button>
            </div>
        </form>
    </div>
</section>
...
} // tpl_aeef96d741744727422490f355fa7ec3
